...
Lab07cpu::Lab07cpu(int argc, char **argv)
{
    init();
...
double& Lab07cpu::locate(long long i, long long j, long long k)
{
    return block[i * shape[1] * shape[2] + j * shape[2] + k];
}

double& Lab07cpu::locate(std::vector<double> &v, long long i, long long j, long long k)
{
