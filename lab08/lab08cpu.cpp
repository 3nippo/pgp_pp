...
Lab08cpu::Lab08cpu(int argc, char **argv)
{
    init();
...
double& Lab08cpu::locate(long long i, long long j, long long k)
{
    return block[i * shape[1] * shape[2] + j * shape[2] + k];
}

double& Lab08cpu::locate(std::vector<double> &v, long long i, long long j, long long k)
{
